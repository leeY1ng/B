...
var browser;
 suite("Cross-Page Tests",function(){
 	...
 	test("requesting a group rate from the pregon coast tour page should "+"populate the referrer field",function(done){
 		var referrer = "http://localhost:3000/tours/oregon-coast";
 		browser.visit(referrer,function(){
 			browser.clickLink(".requestGroupRte",function(){
